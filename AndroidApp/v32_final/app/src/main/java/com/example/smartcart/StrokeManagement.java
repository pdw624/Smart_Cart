...
public class StrokeManagement extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stroke_management);
        ...
        btn_userinfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new StrokeManagement.BackgroundTask().execute();
            }
        });
        btn_stock.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new StrokeManagement.BackgroundTask2().execute();
            }
        });
        btn_sales.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(StrokeManagement.this, SaleManagement.class);
        ...
        btn_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(StrokeManagement.this,AdminMenu.class);
                startActivity(intent);
            }
        });
        ...
        try{
            ...
            while(count < jsonArray.length()){
                ...
                strokePrice = object.getString("strokePrice") + "원";
                strokeQuantity = object.getString("strokeQuantity") +"개";
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String> {
        ...
        public void onPostExecute(String result) {
            Intent intent = new Intent(StrokeManagement.this, Management.class);
            intent.putExtra("userList", result);
            StrokeManagement.this.startActivity(intent);
        }
    }
    ...
    class BackgroundTask2 extends AsyncTask<Void, Void, String> {
        ...
        @Override
        public void onPostExecute(String result) {
            Intent intent = new Intent(StrokeManagement.this, StrokeManagement.class);
