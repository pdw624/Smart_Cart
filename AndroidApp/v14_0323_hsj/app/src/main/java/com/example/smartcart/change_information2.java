...
//                                String userPhone = jsonObject.getString("userPhone");
                                ...
                                if(userNewpassword.equals(userNewpasswordcheck))
                                {
                                    ...
                                    Intent intent = new Intent(change_information2.this, UserMenu.class);
        ...
        btn_userinfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(change_information2.this, ShoppingList.class);
                startActivity(intent);
            }
        });
        ...
        btn_stock.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(change_information2.this, purchase_history.class);
                startActivity(intent);
            }
        });
