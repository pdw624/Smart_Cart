...
namespace smartcart_1
{
    ...
    public partial class ProductOrder : Form
    {
        ...
        private void btnOrder_Click(object sender, EventArgs e)
        {
            ...
            string Query3 = "INSERT INTO inbound (product, quantity, date) values ('" + cbBoxPdName.SelectedItem + "', '" + PdQuantity + "', '" + dateTimePicker1.Value.Year + "-" + dateTimePicker1.Value.Month + "-" + dateTimePicker1.Value.Day + "')";
            MySqlConnection condata3 = new MySqlConnection(constring1);
            MySqlCommand cmddata3 = new MySqlCommand(Query3, condata3);
            MySqlDataReader myreader3;
            try
            {
                condata3.Open();
                myreader3 = cmddata3.ExecuteReader();
                MySqlDataAdapter adapter1 = new MySqlDataAdapter(Query3, condata3);
