...
namespace smartcart_1
{
    ...
    public partial class Main : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            //string insertSql = "INSERT INTO cart VALUES('123','321','333')";
            //DataTable insert = db.GetDBTable(insertSql);
        ...
        private void btnCart_Click(object sender, EventArgs e)
        {
            ...
            //string insertSql = "INSERT INTO cart VALUES('"&SocketHandler.cartNumber&"', '"& SocketHandler.cartNumber & "', '"& SocketHandler.cartNumber & "')";
            //DataTable insert = db.GetDBTable(insertSql);
